 ...
 * @author edson
 */
public class TelaAlterarBicicleta extends javax.swing.JFrame {

    /**
     * Creates new form TelaCadastroCarro
     */
    public TelaAlterarBicicleta() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8_edit_24px_1.png"))); // NOI18N
        ...
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 280, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/veiculo/tela_alteracao_bicicletas.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAlterarBicicleta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaAlterarBicicleta().setVisible(true);
            }
        });
    }
