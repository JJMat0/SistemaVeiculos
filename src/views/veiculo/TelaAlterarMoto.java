 ...
 * @author edson
 */
public class TelaAlterarMoto extends javax.swing.JFrame {

    /**
     * Creates new form TelaCadastroCarro
     */
    public TelaAlterarMoto() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox5.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Gasolina", "Gasóleo" }));
        ...
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 80, 140, -1));

        jComboBox1.setBackground(new java.awt.Color(217, 217, 217));
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nenhum", "Banco Lateral" }));
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 80, -1, -1));
        ...
        getContentPane().add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 290, 140, -1));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/veiculo/tela_alteracao_moto.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAlterarMoto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaAlterarMoto().setVisible(true);
            }
        });
    }
